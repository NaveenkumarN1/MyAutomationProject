...
public class Droppable extends CoreBase {
 ...
 //---sc 2
		  ...
		  WebElement from2 =driver.findElement(By.xpath("//*[@id=\"draggable-nonvalid\"]"));
		  WebElement from3 =driver.findElement(By.xpath("//*[@id=\"draggable\"]"));
		  WebElement to1 =driver.findElement(By.xpath("//*[@id=\"droppable\"]"));
		  ac.dragAndDrop(from2, to1).build().perform();
		  ac.dragAndDrop(from3, to1).build().perform();
  }
}

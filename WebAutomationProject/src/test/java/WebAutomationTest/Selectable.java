...
public class Selectable extends CoreBase {
  @Test
  public void Select() {
	 ...
	 String Parenthandle=driver.getWindowHandle();
	  ...
	  WebElement element= driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/form/div/div[1]/p/a"));
		 WebDriverWait wc = new WebDriverWait(driver,120);
		  ...
		  WebElement ele=driver.findElement(By.xpath("//h2[contains(text(),'Selectable')]"));
		  je.executeScript("arguments[0].scrollIntoView();",ele);
		 
		  je.executeScript("arguments[0].click();", ele);
		 
		  driver.findElement(By.xpath("//h2[contains(text(),'Selectable')]")).click();
		 ...
		 WebElement from1 =driver.findElement(By.xpath("//*[@id=\"selectable\"]/li[1]"));
		 WebElement from2 =driver.findElement(By.xpath("//*[@id=\"selectable\"]/li[4]"));
		 // WebElement to =driver.findElement(By.xpath("//p[contains(text(),'Drop here')]"));
		  Actions ac=new Actions(driver);
		 ac.clickAndHold(from1).moveToElement(from2).release(from2).build().perform();
  }
}
